...
namespace ExactArithmetic
{
  ...
  class Rational
  {
    public:
      ...
      //  Construct a Rational from a dividend and a divisor.
      Rational(long long int dividend, long long int divisor);
      ...
      // Conversion to other numeric types (may lose precision).
      int toInt() const; // Rounds down.
    ...
    private:
       ...
       *   - the denominator is always positive; negative rational numbers
